...
Ce chapitre traite de la détection de sections et d'entités dans les décisions jurisprudentielles françaises. Ces documents comprennent plusieurs informations organisées en sections: 
\begin{enumerate}
\item la section ENTETE contient des métadonnées de référence (date, lieu, identifiant, parties impliquées, juges, affaires antérieurs liés, ...); 
