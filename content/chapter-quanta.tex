...
\begin{enumerate}
    ...
    \item lire chaque document choisi pour identifier les demandes tout en remplissant le tableau des demandes de références dont un extrait est illustré par le Tableau \ref{}.
\end{enumerate}
