...
\splitdfrac{\backslash p{Digit}(\backslash p{Digit}|[',.]|\backslash s)*}{(euro[s]\left\{0,1\right\}|franc[s]\left\{0,1\right\}|\euro{}|F|CFP|XPF|EUR|EUROS)( |\$)}\label{equation:quanta:regex-argent} % Ђ 
\end{equation}
...
Résolution des références: Représentation de la paire: agrégation par concaténation, max, ou soustraction
