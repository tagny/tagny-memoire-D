...
\subsubsection{Les modèles de Markov cachés (HMM)}
...
\centering
\includegraphics [width=0.42\textwidth]{structuration-preprocess.png}
%\caption{Collecte et pré-traitement des décisions.}
%\end{subfigure}
%\begin{subfigure}[ht]{\textwidth}
%\centering
\includegraphics [width=0.57\textwidth]{structuration-pipeline-application.png}
%\caption{Étiquetage des sections puis des entités.}
%\end{subfigure}
%\end{center}
...
Il est également possible d'obtenir des descripteurs à partir du résultat d'autres tâches d'analyse de textes dont les rôles grammaticaux (\textit{Part-of-Speech}) comme \citet{chang2005applyingNER} et les modèles thématiques (\textit{topic model}) comme \citet{polifroni2011usingLDA} et \citet{nallapati2010blinddomaintransferner}. Le \tableref{tab:structuration:descripteursmots} résume l'ensemble des descripteurs caractéristiques définis pour la détection des entités.
