...
\begin{itemize}
	\item l'entête contient de nombreuses métadonnées de référence comme la date, le lieu, les participants, etc.
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.5\textwidth]{confusion_matrix_section.png}
	%\textcolor{red}{Matrices de confusion}
