...
\begin{center}
\begin{tabular}{p{1.5cm}|c|cccccccc}
\hline \noalign{\smallskip}
Tâche & Modèle & \multicolumn{3}{c}{Niveau mot$^a$} & \multicolumn{3}{c}{Niveau entité$^a$} & Durée & Schéma \\
 & & Précision & Rappel & F1 &  Précision & Recall & F1 & d'entrainement$^b$ & \\ \hline %\noalign{\smallskip}\svhline\noalign{\smallskip}
...
$^b$ Durée en secondes avant l'arrêt de l'entrainement
\end{table}
...
\hline\noalign{\smallskip}
Detection Task & Tagger & \multicolumn{3}{c}{niveau mot$^a$} & \multicolumn{3}{c}{niveau entité$^a$}& Sous-ensemble \\
...
\subsection{Croissance de l'apprentissage avec l'expérience}
...
\subsection{Evaluation détaillée pour chaque type d'entité et section}
...
\end{subfigure} 
\caption{Précision, Rappel, F1-mesures pour chaque type d'entité et section au niveau élément.}\label{tab:structuration:perf-detail-token}
\end{table}
