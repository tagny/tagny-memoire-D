...
\begin{figure}[!htb]
	\centering \includegraphics[scale=1]{distance_matrix.png}
...
\begin{table}[!htb]
	...
	\begin{tabular}{|l|c|c|c||c|c|c|}
		...
		$Dis_\mathcal{M}$ &3&-0.00&0.07&0.45&0.51& 0.48 \\ \hline
		$Dis_{braycurtis}$ &3&0.04&0.05&0.50&0.44&0.47 \\ \hline
		$Dis_{cos}$ &3&0.08&0.06&0.52&0.51&0.52 \\ \hline
		$Dis_{soft-cos}$ &3&&&&&  \\ \hline
		$Dis_{manhattan}$ &3&-0.04&0.04&0.40&0.92&0.56  \\ \hline
		$Dis_{euclidienne}$ &3&0.08&0.06&0.52&0.51&0.52  \\ \hline
		$Dis_{jaccard}$ &3&0.08&0.06&0.52&0.51&0.52 \\ \hline
		$Dis_{pearson}$ &3&0.08&0.06&0.52&0.51&0.52  \\ \hline
		$Dis_{wmd}$ &3&-0.02&0.01&0.45&0.37& 0.41 \\ \hline	
...
\begin{table}[!htb]
	...
	\begin{tabular}{|l|c|c|c|c|}
		...
		$Dis_\mathcal{M}$  &3&0.00&& \\ \hline
		$Dis_{cos}$  &3&0.01&&  \\ \hline
		$Dis_{soft-cos}$  &3&&& \\ \hline
		$Dis_{manhattan}$  &3&0.01&&  \\ \hline
		$Dis_{euclidienne}$  &3&0.01&&  \\ \hline
		$Dis_{jaccard}$  &3&0.01&&  \\ \hline
		$Dis_{pearson}$  &3&0.01&&  \\ \hline
		$Dis_{wmd}$  &3&0.00&&  \\ \hline	
	\end{tabular}
