...
\begin{itemize}
	...
	\item la similarité cosinus est basée sur la mesure de l'angle entre les vecteurs représentant les documents $x$ et $x'$, et est calculée par: $Sim_{cos}(x,x') = \frac{x^Tx'}{\norm{x}\norm{x'}}$.
	
	La similarité cosinus  étant comprise en -1 et +1, sa forme normalisée s'écrit  $Sim_{cos}(x,x') = \frac{\frac{x^Tx'}{\norm{x}\norm{x'}} + 1}{2}$, d'où la distance $Dis_{cos}(x,x') = 1 - Sim_{cos}(x,x')$.
