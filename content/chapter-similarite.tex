...
La similarité est donc calculée en général par $Sim(x,x') = 1 - Dis(x,x')$, la distance représentant la dis-similarité.
...
\begin{itemize}
	...
	\item la similarité cosinus: $Dis(x,x') = \sqrt{\frac{x^Tx'}{\norm{x}\norm{x'}}}$
