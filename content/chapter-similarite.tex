...
La représentation vectorielle qui donne la meilleure silhouette pour le clustering manuel est celle qui permet une meilleure séparation entre les clusters et cohésion dans chaque cluster, donc par conséquent une meilleur distribution des points dans l'espace pour reconnaître des cluster donc la sémantique est de même nature que celle de l'annotation manuelle. Pour chaque distance, le modèle vectoriel optimal sur le clustering manuel devrait être optimale pour un clustering selon les métriques d'évaluation supervisée. Le Tableau \ref{tab:similarite:validation-supervisee-k3} présente les mesures ARI, NMI et F1-mesure du clustering par k-means et k-medoids sur $\mathcal{D}_{arcpa}$, avec $K=3$.
...
\begin{table}[!htb]
	...
	\end{tabular}
	\caption{Evaluation supervisée du K-means et du K-medoids sur $\mathcal{D}_{arcpa}$ avec le nombre de clusters prédéfini à $K=3$.} \label{tab:similarite:validation-supervisee-k3}
\end{table}
...
\begin{table}[!htb]
	...
	\begin{tabular}[pos]{|l|l|c|c|c|c|c|c|c|}
		...
		dis\_m          & kmeans    & 3 & 0.442      & 0.390  & 0.413 & 0.478  & 0.653     & 0.536 \\ \hline
		dis\_m          & kmedoids  & 6 & 0.453      & 0.359  & 0.395 & 0.298  & 0.669     & 0.413 \\ \hline
		dis\_braycurtis & kmeans    & 4 & 0.473      & 0.371  & 0.396 & 0.428  & 0.658     & 0.517 \\ \hline
		dis\_braycurtis & kmedoids  & 5 & 0.452      & 0.395  & 0.423 & 0.356  & 0.694     & 0.471 \\ \hline
		dis\_cosine     & kmeans    & 4 & 0.522      & 0.368  & 0.395 & 0.421  & 0.655     & 0.509 \\ \hline
		dis\_cosine     & kmedoids  & 4 & 0.526      & 0.398  & 0.421 & 0.464  & 0.680     & 0.551 \\ \hline
		dis\_euclidean  & kmeans    & 4 & 0.484      & 0.383  & 0.408 & 0.434  & 0.658     & 0.522 \\ \hline
		dis\_euclidean  & kmedoids  & 5 & 0.456      & 0.313  & 0.346 & 0.335  & 0.619     & 0.434 \\ \hline
		dis\_jaccard    & kmeans    & 4 & 0.567      & 0.376  & 0.400 & 0.434  & 0.654     & 0.521 \\ \hline
		dis\_jaccard    & kmedoids  & 4 & 0.560      & 0.389  & 0.412 & 0.451  & 0.666     & 0.538 \\ \hline
		dis\_manhattan  & kmeans    & 4 & 0.476      & 0.379  & 0.404 & 0.437  & 0.657     & 0.524 \\ \hline
		dis\_manhattan  & kmedoids  & 5 & 0.452      & 0.368  & 0.397 & 0.345  & 0.675     & 0.456 \\ \hline
		dis\_pearson    & kmeans    & 2 & 0.634      & 0.046  & 0.063 & 0.653  & 0.452     & 0.534 \\ \hline
	...
	\end{tabular}
	\caption{Validation supervisée sur $\mathcal{D}_{arcpa}$ avec détermination du nombre de clusters avec la silhouette.} \label{tab:similarite:validation-supervisee-optKbySilhouette}
\end{table}

\subsection{Clustering des corpus non annotés manuellement}
