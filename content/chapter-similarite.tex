...
\begin{table}[!htb]
	\scriptsize
	\begin{center}		
	\begin{tabular}{|l|l|l|c|c|c|c|c|c|c|c|}%"algorithm","K","lw","gw","s","wcss","ARI","NMI","AMI","P","R","F1"
		\hline
		Distance & Algorithme & lw& gw& S$_{max}$ & WCSS & ARI& NMI& P& R& F1 \\ \hline
		$Dis_\mathcal{M}$ & kmeans  & TP & MAR & 0.172 & 15.654 & -0.004 & 0.032 & 0.396 & 0.356 & 0.374 \\ \hline
		$Dis_{braycurtis}$ & kmeans  & TP & CHI2 & 0.308 & 16.689 & -0.007 & 0.099 & 0.397 & 0.472 & 0.426 \\ \hline
		$Dis_{cos}$ & kmeans  & LOGAVE & CHI2 & 0.323 & 1.567 & 0.039 & 0.100 & 0.424 & 0.380 & 0.400 \\ \hline
		$Dis_{euclidean}$ & kmeans  & LOGAVE & CHI2 & 0.252 & 35.305 & 0.010 & 0.078 & 0.405 & 0.397 & 0.398 \\ \hline
		$Dis_{jaccard}$ & kmeans  & LOGAVE & MAR & 0.329 & 4.713 & 0.049 & 0.039 & 0.420 & 0.603 & 0.491 \\ \hline
		$Dis_{manhattan}$ & kmeans  & ATF & CHI2 & 0.273 & 2103.432 & 0.002 & 0.080 & 0.401 & 0.407 & 0.401 \\ \hline
		$Dis_{pearson}$ & kmeans  & ATF & MAR & 0.374 & 5.915 & 0.067 & 0.043 & 0.425 & 0.714 & 0.533 \\ \hline
	\end{tabular}
...
\begin{table}[!htb]
	...
	\begin{center}		
		\begin{tabular}{|l|l|l|c|c|c|c|c|c|c|c|}%"algorithm","K","lw","gw","s","wcss","ARI","NMI","AMI","P","R","F1"
			\hline
			Distance & Algorithme & lw& gw& S & WCSS$_{min}$ & ARI& NMI& P& R& F1 \\ \hline
			$Dis_\mathcal{M}$ & kmedoids  & LOGAVE & NGL & -0.000 & 4.585 & -0.027 & 0.029 & 0.390 & 0.927 & 0.549 \\ \hline
			$Dis_{braycurtis}$ & kmedoids  & ATF & MAR & -0.015 & 4.949 & -0.003 & 0.030 & 0.396 & 0.331 & 0.361 \\ \hline
			$Dis_{cos}$ & kmedoids  & ATF & MAR & 0.004 & 0.341 & 0.005 & 0.049 & 0.402 & 0.347 & 0.372 \\ \hline
			$Dis_{euclidean}$ & kmedoids  & ATF & MAR & -0.015 & 15.019 & 0.014 & 0.039 & 0.408 & 0.370 & 0.388 \\ \hline
			$Dis_{jaccard}$ & kmeans  & ATF & MAR & 0.321 & 3.858 & 0.034 & 0.037 & 0.415 & 0.534 & 0.461 \\ \hline
			$Dis_{manhattan}$ & kmedoids  & ATF & MAR & 0.033 & 449.012 & 0.044 & 0.060 & 0.428 & 0.372 & 0.398 \\ \hline
			$Dis_{pearson}$ & kmeans  & LOGTF & IG & 0.131 & 5.231 & 0.017 & 0.057 & 0.411 & 0.358 & 0.382 \\ \hline
		\end{tabular}
