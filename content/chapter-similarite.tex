 \chapter{Modélisation des Circonstances Factuelles par regroupement non supervisé des documents}
...
Pour l'évaluation supervisée, nous disposons d'une base annotée sur la catégorie de demande "dommage-intérêts / action en responsabilité civile professionnelle contre les avocats" (\textit{dira}) qui concerne les contentieux impliquant des avocats.  L'expert annotateur a annoté 81 documents (Figure \ref{fig:similarite:dira-data-distrib}) avec 6 documents appartenant chacun à 2 circonstances factuelles (chevauchements) parmi les 4 identifiées :
\begin{itemize}
...
%Cet ensemble de données comprend 81 documents répartis dans les 4 groupes (Figure \ref{fig:similarite:dira-data-distrib}) avec 6 documents appartenant chacun à 2 groupes (chevauchements).
...
Les terminologies des différents cas se distinguent bien (Tableau \ref{tab:similarite:terminologie-resp_avocat}), et par conséquent, une représentation des documents qui mettrait en évidence ces différents termes permettrait de retrouver les 
\begin{table}[!htb]
	\centering \small%\scriptsize
	\begin{tabular}{|l|p{.95\textwidth}|}
		\hline
		\textbf{Corpus} & \textbf{Terminologie} \\ \hline
		\textit{dira} & "perte de chance", 
		...
		"exposé complet des prétentions", 
		"débats en audience", 
		"après débats en audience publique", 
		"après débats en audience", 
		...
		"chance réelle", 
		"complet des prétentions", 
		"toute chance"
		\\ \hline
		\textit{cas a} & "perte de chance", 
		"chance", 
		"obtenir gain", 
		"obtenir gain de cause", 
		"chances", 
		...
		"vouée à l' échec"
		\\ \hline
		\textit{cas b} & "412 du code de procédure", 
		"avocat au barreau de dijon", 
		"barreau de dijon", 
		"412 du code", 
		"responsabilité professionnelle", 
		"pouvoir et devoir de conseiller", 
		"devoir de conseiller la partie", 
		"pouvoir général de représentation", 
		"professionnelle des avocats relève", 
		"procédure civile , l' avocat", 
		"professionnelles , en sorte", 
		"relève de la responsabilité contractuelle", 
		"responsabilité professionnelle des avocats", 
		"tous les actes nécessités", 
		"intérêts sans l' obliger", 
		"instance en s' assurant", 
		"imposant d' accomplir tous", 
		"imposant d' accomplir", 
		"justice lui imposant", 
		"justice emportant pouvoir et devoir"
		\\ \hline
		\textit{cas c} & "avocat rédacteur", 
		"rédacteur d' acte", 
		"rédacteur d' un acte", 
		"avocat rédacteur d' un acte", 
		...
		"rédacteur d' un acte juridique", 
		"validité et la pleine", 
		"initiative de conseiller les deux", 
		"engagements souscrits de part", 
		"7.2 du règlement intérieur", 
		"article 7.2 du règlement intérieur", 		
		\\ \hline
		\textit{cas d} & "effectivement faire droit", 
		"effet les saisies attribution", 
		"effectivement tenue", 
		"effectivement faire droit aux demandes", 
		"pénale et l' autre civile", 
		"pénale en cours en suisse", 
		"bourg en bresse , tandis", 
		"flatteurs", 
		"tribunal pouvait valablement être saisi", 
		"bon fonctionnement de la justice", 
		"octobre 2007 comportait", 
		"transmises le 10 juin 2016", 
		"trophée , observant en particulier", 
		"pénale et l' autre", 
		"effet les saisies", 
		"effet les saisies attribution pratiquées", 
		"octobre 2010 , la mise", 
		"occupation , de sorte", 
		"octobre 2010 ; statuant", 
		"tant la sarl institut", 
		\\ \hline
	\end{tabular}

	\textit{20 premiers termes sélectionnés à l'aide du coefficient de corrélation $ngl$ (cf. \ref{sec:quanta:poids-globaux-superv})}
	\caption{Terminologies  de la catégorie \textit{dira}, et de ses circonstances factuelles annotées.}\label{tab:similarite:terminologie-resp_avocat}
\end{table}
