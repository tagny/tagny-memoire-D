...
\begin{figure}
	\centering \includegraphics[scale=0.4]{dira-data-distrib.png}
	\caption{Répartition des documents annotés par circonstances factuelles (action en responsabilité civile professionnelle contre les avocats).}\label{fig:similarite:dira-data-distrib}
\end{figure}
...
\begin{figure}[!htb]
	\centering \includegraphics[scale=0.5]{distance_matrix.png}
...
\begin{table}[!htb]
  ...
  \begin{tabular}{|l|c|c||c|c|}
	...
	$Dis_{euclidienne}$ &1.371&1.325&0.046&  \\ \hline
	$Dis_{jaccard}$ &&&&  \\ \hline
	$Dis_{pearson}$ &&&&  \\ \hline
	$Dis_{wmd}$ &&&&  \\ \hline	
  \end{tabular}
