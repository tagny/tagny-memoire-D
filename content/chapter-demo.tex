...
Pour avoir une idée du montant qu'on peut recevoir sur pour une catégorie de demande, l'évolution des valeurs généralement accordés peut être comparée entre deux villes en visualisant les boîtes à moustaches (\textit{boxplot}) 
